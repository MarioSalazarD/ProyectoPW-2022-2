        ...
        <Container className="vh-100 d-flex flex-column ">
            ...
            <Row className="h-100">
                <Col className='body-main'>
                      ...
                      <img src="https://www.pngplay.com/wp-content/uploads/12/CPU-PNG-HD-Images.png" style={{height:'460px' ,width: '400px', 'margin-top': '-300px', marginLeft: '80px'}}></img>
                      ...
                      <table style={{height: '250px' , border:'none'}}>
                        <tbody>
                            <tr style={{ border: '1px solid'}}>
                                ...
                                <td style={{width: '120px', 'fontSize': '14px'}}>NVIDIA GTX 1660 </td>
                      ...
                      <Card style={{ color:'grey',display: 'inline-block' ,height: '100px' ,width: '300px', 'margin-top': '1%', 'margin-left':'120px',backgroundColor: 'hsl(242, 41%, 24%)', border: 'none'}}>
                        <table  style={{height: '100px' , border:'none'}}>
                            <tbody>
                                ...
                                <tr>
                                    <td style={{'fontSize': '22px', textAlign:'center'}}>$1226</td>
